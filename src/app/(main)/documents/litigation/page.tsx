...
const litigationFolders = [
    { name: '01 Civiles', size: '1.2 GB', modified: '2024-05-21' },
    { name: '02 Mercantiles', size: '850 KB', modified: '2024-05-20' },
    { name: '03 Penales', size: '3.5 MB', modified: '2024-05-18' },
    { name: '04 Fiscales', size: '2.1 MB', modified: '2024-05-17' },
    { name: '05 Administrativos', size: '5.2 MB', modified: '2024-05-16' },
    { name: '06 Laborales', size: '4.8 MB', modified: '2024-05-15' },
];
        ...
        <div className="space-y-8">
            <div>
                <div className="flex items-center gap-2 text-sm text-muted-foreground mb-2">
                    ...
                    <span className="text-foreground">Litigios</span>
                </div>

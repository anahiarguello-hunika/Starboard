...
const kpiCards = [
    { title: "Auditorías en revisión", value: "1" },
    { title: "Auditorías en borrador", value: "1" },
    { title: "Auditorías vencidas", value: "0" },
    { title: "Auditorías por aprobar", value: "2" },
    { title: "Auditorías activas", value: "3" },
    { title: "Auditorías creadas este mes", value: "2" },
];
    ...
    const TableView = () => (
        <Card>
          <Table>
            <TableHeader>
                <TableRow>
                <TableHead>Nombre de la Auditoría</TableHead>
    ...
    <div className="space-y-8">
        <div className="grid grid-cols-[320px_1fr] gap-8 items-start">
            <div className="flex flex-col gap-8">
                    ...
                    <h1 className="text-xl font-semibold">Panel de Gestión de Auditorías</h1>
                    <ChevronDown className="h-5 w-5 text-muted-foreground" />
                </div>
                <Card>
                    <CardContent className="p-4 space-y-4">
                        <div className="relative">
                            <Input placeholder="Tipo de Auditoría" className="h-8" />
            ...
            <div className="grid grid-cols-2 gap-8 items-start">
                <Card>
                    <CardHeader className="flex flex-row justify-between items-center">
                        <CardTitle className="text-base">Auditorías por Estado</CardTitle>
                        <div className="flex items-center gap-2 text-muted-foreground">
                            ...
                            <ResponsiveContainer width="100%" height="100%">
                                <PieChart>
                                    <ChartTooltip 
                                        ...
                                        />} 
                                    />
                                    <Pie data={auditsStatusData} dataKey="value" nameKey="name" innerRadius="60%" outerRadius="100%">
                                        {auditsStatusData.map((entry, index) => <Cell key={`cell-${index}`} fill={entry.fill} />)}
                                    </Pie>
                ...
                <Card>
                    <CardHeader className="flex flex-row justify-between items-center">
                        <CardTitle className="text-base">Auditorías por Mes</CardTitle>
                        <div className="flex items-center gap-2 text-muted-foreground">
                            <RefreshCw className="h-4 w-4 cursor-pointer" />
                            <X className="h-4 w-4 cursor-pointer" />
                        </div>
                    ...
                    <CardContent className="h-[300px]">
                        <ChartContainer config={{}} className="w-full h-[300px]">
                            <ResponsiveContainer width="100%" height="100%">
                                <RechartsBarChart data={auditsByMonthData} margin={{ top: 5, right: 20, left: 20, bottom: 5 }}>
                                    <CartesianGrid strokeDasharray="3 3" vertical={false} />
                                    <XAxis dataKey="name" tick={{ fontSize: 12 }} />
                                    <YAxis 
                                        tickFormatter={(value) => value.toLocaleString()} 
                                        tick={{ fontSize: 12 }} 
                                        label={{ value: 'Número de Auditorías', angle: -90, position: 'insideLeft', offset: -10, style: { fontSize: '12px' } }} 
                                    />
                                    ...
                                    />
                                    <Bar dataKey="value" name="Auditorías" fill="hsl(var(--chart-2))" />
                                </RechartsBarChart>
                            </ResponsiveContainer>
                        </ChartContainer>
                    </CardContent>
        ...
        <div className="flex items-center justify-between">
            <div>
                ...
                Visualice y gestione sus auditorías legales.
                </p>
            </div>

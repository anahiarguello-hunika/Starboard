...
const concessionsFolders = [
    { name: '01 Títulos de concesión', size: '1.2 GB', modified: '2024-05-21' },
    { name: '02 Permisos y autorizaciones', size: '850 KB', modified: '2024-05-20' },
];
        ...
        <div className="space-y-8">
            <div>
                <div className="flex items-center gap-2 text-sm text-muted-foreground mb-2">
                    ...
                    <span className="text-foreground">Concesiones</span>
                </div>

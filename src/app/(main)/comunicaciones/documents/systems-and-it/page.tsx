...
const systemsFolders = [
    { name: '01 Descripción General de Infraestructura en Sistemas', size: '1.2 GB', modified: '2024-05-21' },
    { name: '02 Contratos de Licencias de Software', size: '850 KB', modified: '2024-05-20' },
    { name: '03 Protección de Datos y Políticas de Privacidad', size: '3.5 MB', modified: '2024-05-18' },
    { name: '04 Otros', size: '5.2 MB', modified: '2024-04-10' },
];


export default function SystemsAndItPage() {
    const [view, setView] = React.useState<'grid' | 'list'>('grid');

    const GridView = () => (
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
            {systemsFolders.map((folder) => (
        ...
        <div className="space-y-8">
            <div>
                <div className="flex items-center gap-2 text-sm text-muted-foreground mb-2">
                    ...
                    <span className="text-foreground">Sistemas y TI</span>
                </div>

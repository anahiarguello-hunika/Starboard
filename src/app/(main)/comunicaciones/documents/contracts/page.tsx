...
const contractsFolders = [
    { name: '01 Contratos con Clientes', size: '4.1 MB', modified: '2024-05-21' },
    { name: '02 Contratos con Proveedores', size: '12.8 MB', modified: '2024-05-20' },
    { name: '03 Contratos de Fusiones y Adquisiciones', size: '2.5 MB', modified: '2024-05-20' },
    { name: '04 Convenios de Confidencialidad', size: '3.1 MB', modified: '2024-05-18' },
    { name: '05 Contratos de servicio', size: '6.7 MB', modified: '2024-04-15' },
    { name: '06 Contratos de distribución', size: '1.2 MB', modified: '2024-05-01' },
    { name: '07 Contratos de licencia', size: '5.9 MB', modified: '2024-03-22' },
    { name: '08 Términos y condiciones', size: '850 KB', modified: '2024-05-11' },
    { name: '09 Aviso de Privacidad', size: '430 KB', modified: '2024-05-11' },
    { name: '10 Otros', size: '1.5 MB', modified: '2024-05-11' },
];
        ...
        <div className="space-y-8">
            <div>
                <div className="flex items-center gap-2 text-sm text-muted-foreground mb-2">
                    ...
                    <span className="text-foreground">Contratos</span>
                </div>

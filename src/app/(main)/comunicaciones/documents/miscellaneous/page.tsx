...
const miscellaneousFolders = [
    { name: '01 Propuestas', size: '1.2 GB', modified: '2024-05-21' },
    { name: '02 Presentaciones', size: '850 KB', modified: '2024-05-20' },
    { name: '03 Documentos de trabajo', size: '3.5 MB', modified: '2024-05-18' },
    { name: '04 Memoranda', size: '2.1 MB', modified: '2024-05-17' },
    { name: '05 Correos', size: '5.2 MB', modified: '2024-05-16' },
];
...
export default function MiscellaneousPage() {
    ...
    const GridView = () => (
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
            {miscellaneousFolders.map((folder) => (
        ...
        <div className="space-y-8">
            <div>
                <div className="flex items-center gap-2 text-sm text-muted-foreground mb-2">
                    ...
                    <span className="text-foreground">Misceláneos</span>
                </div>

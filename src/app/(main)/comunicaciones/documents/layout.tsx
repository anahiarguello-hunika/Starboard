...
const documentsNav = [
    ...
    { name: 'Concesiones', icon: FileCheck, href: "/comunicaciones/documents/concessions" },
    { name: 'Formatos', icon: FileType, href: "/comunicaciones/documents/formats" },
    { 
        name: 'Miscelaneos', 
        icon: Book, 
    ...
    { name: 'Otros', icon: MoreHorizontal, href: "/comunicaciones/documents/others" },
];

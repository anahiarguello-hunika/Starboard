        ...
        <div className="space-y-8">
            <div>
                <div className="flex items-center gap-2 text-sm text-muted-foreground mb-2">
                    ...
                    <span className="text-foreground">Testamento</span>
                </div>
            ...
            <Card>
                <CardContent className="p-4">
                   {testamentoFolders.length > 0 ? (view === 'grid' ? <GridView /> : <ListView />) : <div className="text-center py-12 text-muted-foreground">No hay documentos en esta carpeta.</div>}
                </CardContent>
            </Card>
        </div>
    );

...
const insuranceFolders = [
    { name: '01 Seguros', size: '1.2 GB', modified: '2024-05-21' },
    { name: '02 Póliticas de Seguros', size: '850 KB', modified: '2024-05-20' },
    { name: '03 Demandas y reclamaciones', size: '3.5 MB', modified: '2024-05-18' },
];
        ...
        <div className="space-y-8">
            <div>
                <div className="flex items-center gap-2 text-sm text-muted-foreground mb-2">
                    ...
                    <span className="text-foreground">Seguros</span>
                </div>

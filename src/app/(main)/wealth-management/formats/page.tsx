...
const formatsFolders = [
    { name: '01 Formatos de contratos', size: '1.2 GB', modified: '2024-05-21' },
    { name: '02 Formatos de actas', size: '850 KB', modified: '2024-05-20' },
    { name: '03 Formatos de políticas', size: '3.5 MB', modified: '2024-05-18' },
];
        ...
        <div className="space-y-8">
            <div>
                <div className="flex items-center gap-2 text-sm text-muted-foreground mb-2">
                    ...
                    <span className="text-foreground">Formatos</span>
                </div>

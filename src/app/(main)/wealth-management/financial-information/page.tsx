...
const financialFolders = [
    { name: '01 Estados Financieros', size: '3.1 MB', modified: '2024-03-15' },
    { name: '02 Reportes de Auditoría', size: '15.5 MB', modified: '2024-02-28' },
    { name: '03 Documentos Fiscales', size: '8.2 MB', modified: '2024-04-10' },
    { name: '04 Préstamos y documentos financieros', size: '25.0 MB', modified: '2023-12-01' },
    { name: '05 Pagarés', size: '1.8 MB', modified: '2024-01-20' },
    { name: '06 Fianzas', size: '2.2 MB', modified: '2023-11-15' },
    { name: '07 Planeación de gastos', size: '500 KB', modified: '2024-05-01' },
    { name: '08 Cuentas de administración', size: '1.2 MB', modified: '2024-04-25' },
    { name: '09 Presupuestos y Pronósticos', size: '4.7 MB', modified: '2024-05-10' },
];
        ...
        <div className="space-y-8">
            <div>
                <div className="flex items-center gap-2 text-sm text-muted-foreground mb-2">
                    ...
                    <span className="text-foreground">Información Financiera</span>
                </div>

...
const entityNav = [
  ...
  { name: 'UBO', icon: Users },
  { name: 'Organisational chart', icon: AppWindow },
  { name: 'Documents', icon: Library },
              ...
              <Alert className="bg-blue-50 border-blue-200 text-blue-900">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <AlertDescription>
                      Corporify offers a fully digital managed share register.
                      No more paper book required. This register is fully
                      compliant with the Belgian Companies Code.
                    </AlertDescription>
                  ...
                  <div className="w-32 h-32 bg-contain bg-no-repeat bg-center" style={{backgroundImage: "url('https://placehold.co/128x128.png')"}} data-ai-hint="documents illustration" />
                </div>
              </Alert>
                          ...
                          <TableCell>
                            <div className="flex flex-col gap-1 text-xs">
                              {share.description.map((desc) => (
                                <span key={desc} className="flex items-center gap-2">

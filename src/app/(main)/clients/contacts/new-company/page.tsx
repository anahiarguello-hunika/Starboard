...
import { Info, Upload, User, Building, PlusCircle } from "lucide-react";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                   ...
                   <FormSection title="Información de contacto">
                        <div className="flex justify-between items-start">
                            <div>
                                ...
                                <RadioGroup defaultValue="company" className="flex mt-2">
                                    <Button variant="ghost"><User className="mr-2 h-4 w-4"/> Persona</Button>
                                    <Button variant="outline" className="bg-muted"><Building className="mr-2 h-4 w-4"/> Empresa</Button>
                                </RadioGroup>
                            </div>
                            <div>
                        ...
                        <div className="space-y-1 mt-6">
                            <Label htmlFor="company-name">Nombre <span className="text-destructive">*</span></Label>
                ...
                <div className="lg:col-span-1 space-y-6">
                   <FormSection title="Campos personalizados">
                    ...
                    <FormSection title="Empleados">
                         <div className="space-y-1">
                            <Label htmlFor="employee-contact">Contacto</Label>
                            <Select>
                                <SelectTrigger id="employee-contact"><SelectValue placeholder="¿Cuál es el nombre de la persona?" /></SelectTrigger>
                                <SelectContent></SelectContent>
                            </Select>
                        </div>
                        <Button variant="link" className="p-0 mt-2"><PlusCircle className="mr-2 h-4 w-4"/> Agregar empleado</Button>
                   </FormSection>
